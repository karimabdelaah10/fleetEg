...
window.colors = {
  ...
  if ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")), t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, {
    ...
    var r = !1;
    n.hasClass("menu-collapsed") && (r = !0), t("html").data("textdirection"), setTimeout(function () {
    ...
    var i = n.data("menu");
    "horizontal-menu" != i && !1 === r && t(".main-menu-content").find("li.active").parents("li").addClass("open"), "horizontal-menu" == i && (t(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), t(".main-menu-content").find("li.active").closest("li.nav-item").addClass("sidebar-group-active open"));
    var l = t(".chartjs"),
        c = l.children("canvas").attr("height"),
        d = t(".main-menu");

    if (l.css("height", c), n.hasClass("boxed-layout") && n.hasClass("vertical-overlay-menu")) {
      var h = d.width(),
    ...
    t(".custom-file-input").on("change", function (a) {
      t(this).siblings(".custom-file-label").html(a.target.files[0].name);
      ...
      !function (e, s) {
        ...
        t(".char-count").html(e.value.length), e.value.length > n ? (r.css("background-color", a.colors.solid.danger), i.css("color", a.colors.solid.danger), i.addClass("max-limit")) : (r.css("background-color", a.colors.solid.primary), i.css("color", o), i.removeClass("max-limit"));
    ...
    var l = e.querySelector(".drag-target"),
        c = "panright",
        d = "panleft";
    if (!0 === i && (c = "panleft", d = "panright"), t(l).length > 0) new Hammer(l).on(c, function (a) {
  ...
  if (g.on("click", function (a) {
    ...
    for (var o = 0; o < e.length; o++) {
      ...
      if (t(e[o].firstChild.firstChild).hasClass("feather")) {
        var l = e[o].firstChild.firstChild.getAttribute("class");
        r = l.split("feather-")[1].split(" ")[0], i = l.split("feather-")[1].split(" ")[1];
      }
      ...
      s += '<li class="auto-suggestion ' + n + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e[o].firstChild.href + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[r].toSvg({
        "class": "mr-75 " + i
      }) + "<span>" + e[o].firstChild.dataset.originalTitle + "</span></div>" + feather.icons.star.toSvg({
  ...
  t(".search-list-main").mouseenter(function () {
    ...
    if (t(this).closest(".search-list").addClass("show"), 38 !== a.keyCode && 40 !== a.keyCode && 13 !== a.keyCode) {
      ...
      if (t("ul.search-list li").remove(), t(this).parent().hasClass("bookmark-input") && (n = !0), "" != e) {
        ...
        var o = "",
            ...
            l = "",
            c = "",
            d = '<li class="d-flex align-items-center"><a href="javascript:void(0)"><h6 class="section-label mt-75 mb-0">Pages</h6></a></li>',
            h = "",
            u = "",
            f = 0;
          ...
          for (var m = 0; m < a.listItems.length; m++) {
            if ("laravel" === t("body").attr("data-framework") && (a.listItems[m].url = r + a.listItems[m].url), !0 === n) {
              ...
              for (var p = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0; v < p.length; v++) {
                if (a.listItems[m].name === p[v].firstChild.dataset.originalTitle) {
                  s = " text-warning";
                  break;
                }
          ...
          for (m = 0; m < a.listItems.length; m++) {
            if (!0 === n) {
              ...
              for (p = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0; v < p.length; v++) {
                s = a.listItems[m].name === p[v].firstChild.dataset.originalTitle ? " text-warning" : "";
              }
            ...
            0 != a.listItems[m].name.toLowerCase().indexOf(e) && a.listItems[m].name.toLowerCase().indexOf(e) > -1 && f < 5 && (i += '<li class="auto-suggestion ' + (0 === f ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + a.listItems[m].url + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[a.listItems[m].icon].toSvg({
              "class": "mr-75 "
            }) + "<span>" + a.listItems[m].name + "</span></div>" + h + "</a></li>", f++);
          }

          u = t(".main-search-list-defaultlist").html(), "" == o && "" == i && (i = t(".main-search-list-defaultlist-other-list").html()), l = d.concat(o, i, u), t("ul.search-list").html(l), c = o.concat(i), t("ul.search-list-bookmark").html(c);
        });
      } else if (!0 === n) {
        for (var m = t("ul.nav.navbar-nav.bookmark-icons li"), v = "", g = 0; g < m.length; g++) {
          ...
          v += '<li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100" href=' + m[g].firstChild.href + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[C].toSvg({
            "class": "mr-75 "
          }) + "<span>" + m[g].firstChild.dataset.originalTitle + "</span></div>" + feather.icons.star.toSvg({
            "class": "text-warning bookmark-icon float-right"
          }) + "</a></li>";
        }
    ...
    t(a.target).hasClass("bookmark-icon") || (S.hasClass("show") && S.removeClass("show"), b.hasClass("show") && b.removeClass("show"));
    ...
    if (a.stopPropagation(), t(this).hasClass("text-warning")) {
      ...
      for (var e = t("ul.nav.navbar-nav.bookmark-icons li"), s = 0; s < e.length; s++) {
        e[s].firstChild.dataset.originalTitle == t(this).parent()[0].innerText && e[s].remove();
      }
      ...
      var n,
          ...
          i = t(this).parent()[0].firstChild.firstChild.dataset.icon;
      if (t(t(this).parent()[0].firstChild.firstChild).hasClass("feather")) i = t(this).parent()[0].firstChild.firstChild.getAttribute("class").split("feather-")[1].split(" ")[0];
      n = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + o + '" data-toggle="tooltip" data-placement="top" title="" data-original-title="' + r + '">' + feather.icons[i].toSvg({
        "class": "ficon"
      }) + "</a></li>", t("ul.nav.bookmark-icons").append(n), t('[data-toggle="tooltip"]').tooltip();
    }
  ...
  t(".nav-link-style").on("click", function () {
    ...
    e = "dark-layout" !== a ? "dark-layout" : n || "light-layout", localStorage.setItem(T + "-prev-skin", a), localStorage.setItem(T + "-current-skin", e), function (a) {
      var e = t(".nav-link-style"),
          n = z(),
          o = t(".main-menu"),
          r = t(".header-navbar"),
          i = a || n;
      s.removeClass("semi-dark-layout dark-layout bordered-layout"), "dark-layout" === i ? (s.addClass("dark-layout"), o.removeClass("menu-light").addClass("menu-dark"), r.removeClass("navbar-light").addClass("navbar-dark"), e.find(".ficon").replaceWith(feather.icons.sun.toSvg({
        "class": "ficon"
      }))) : "bordered-layout" === i ? (s.addClass("bordered-layout"), o.removeClass("menu-dark").addClass("menu-light"), r.removeClass("navbar-dark").addClass("navbar-light"), e.find(".ficon").replaceWith(feather.icons.moon.toSvg({
        "class": "ficon"
      }))) : "semi-dark-layout" === i ? (s.addClass("semi-dark-layout"), o.removeClass("menu-dark").addClass("menu-light"), r.removeClass("navbar-dark").addClass("navbar-light"), e.find(".ficon").replaceWith(feather.icons.moon.toSvg({
        "class": "ficon"
      ...
      t("input:radio[data-layout=" + i + "]").length > 0 && setTimeout(function () {
        t("input:radio[data-layout=" + i + "]").prop("checked", !0);
      });
  ...
  errorPlacement: function errorPlacement(a, e) {
    e.parent().hasClass("input-group") || e.hasClass("select2") || "checkbox" === e.attr("type") ? a.insertAfter(e.parent()) : e.hasClass("custom-control-input") ? a.insertAfter(e.parent().siblings(":last")) : a.insertAfter(e), e.parent().hasClass("input-group") && e.parent().addClass("is-invalid");
  },
