...
class RolesController extends Controller {
    ...
    public function getIndex() {
        ...
        return view($this->views . '::roles.index', $data);
    }

    public function getCreate() {
        authorize('create-' . $this->module);
        $data['module'] = $this->module;
        $data['views'] = $this->views.'::roles';
        $data['page_title'] = trans('app.Create') . " " . $this->title;
        $data['breadcrumb'] = [$this->title => $this->module];
        $data['row'] = $this->model;
        return view($this->views . '::roles.create', $data);
    }
    ...
    public function getEdit($id) {
        ...
        return view($this->views . '::roles.edit', $data);
    }
    ...
    public function getView($id) {
        ...
        $data['breadcrumb'] = [$this->title => $this->module];
        $data['row'] = $this->model->findOrFail($id);
        return view($this->views . '::roles.view', $data);
    }
