            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{$module_url}}/add_products_spec_value/{{$row->id}}" class="add-new btn btn-primary mt-50">{{trans('products.add spec value')}}</a>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div data-toggle="tooltip"
                                                     ...
                                                     data-original-title="{{@$element->value->title}}">
                                            ...
                                            <div class="dropdown dropright">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{$module_url}}/view_product_spec_values_inner/{{@$element->id}}">
