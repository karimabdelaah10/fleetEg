...
@push('js')
    ...
    <script src="/js/pages/wNumb.min.js"></script>
    <script src="/js/pages/nouislider.min.js"></script>
    <script src="/js/pages/app-ecommerce.min.js"></script>

@endpush
@push('css')
    <link rel="stylesheet" type="text/css" href="/css/pages/nouislider.min.css">

    <link rel="stylesheet" type="text/css" href="/css/pages/ext-component-sliders.min.css">
    <link rel="stylesheet" type="text/css" href="/css/pages/app-ecommerce.min.css">
