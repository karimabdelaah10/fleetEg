                ...
                <section id="ecommerce-products" class="grid-view">
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html">Apple Watch Series 5</a>
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html">Apple iPhone 11 (64GB, Black)</a>
                                <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
                            </h6>
                            <p class="card-text item-description">
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html">Apple iMac 27-inch</a>
                                <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
                            </h6>
                            <p class="card-text item-description">
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html">OneOdio A71 Wired Headphones</a>
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html">
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html"> Switch Pro Controller </a>
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html"> Google - Google Home - White/Slate fabric </a>
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html"> Sony 4K Ultra HD LED TV </a>
                                <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
                            </h6>
                            <p class="card-text item-description">
                    ...
                    <div class="card ecommerce-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="item-name">
                                <a class="text-body" href="one-product.html"> OnePlus 7 Pro </a>
